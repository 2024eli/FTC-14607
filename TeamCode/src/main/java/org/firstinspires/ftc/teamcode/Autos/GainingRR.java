...
import org.firstinspires.ftc.teamcode.Autos.trajectorysequence.*;

@Disabled
@Autonomous(name = "RoadRunner first", group="Test")
public class GainingRR extends LinearOpMode {
    BumbleBee control;
    //OpenCvWebcam webcam;
...
//auto thoomin
        ...
        SleeveDetectPipeline.DetectedColor color = SleeveDetectPipeline.DetectedColor.GREEN;
...
//            webcam.stopRecordingPipeline();
        ...
        Trajectory a = drive.trajectoryBuilder(new Pose2d())
                .forward(30)
                .build();
